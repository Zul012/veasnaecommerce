...
class OrderController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // dd($users);        
        Session::flash('success','Your product order has been placed. Thank you for shopping with us.');
    ...
    public function productTrackOrder(Request $request){
        ...
        if($order){
            ...
            elseif($order->status=="process"){
                Session::flash('success','Your order is currently processing.');
                return redirect()->route('home');
    
            }
            elseif($order->status=="delivered"){
                Session::flash('success','Your order has been delivered. Thank you for shopping with us.');
                return redirect()->route('home');
    
            }
            else{
                Session::flash('error','Sorry, your order has been canceled.');
                return redirect()->route('home');
    
            }
        }
        else{
            Session::flash('error','Invalid order number. Please try again!');
            return back();
        }
    }
